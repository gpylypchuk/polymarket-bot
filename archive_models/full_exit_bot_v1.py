...
csv_filename = os.path.join("logs", "full_exit_experiment_log_v1.csv")
...
print(f"🎯 Rango de Entrada: 0.01 - 0.03")
                ...
                if hot_zone_extrema or hot_zone_normal:
                    ...
                    if best_ask:
                        ...
                        if 0.01 <= best_ask <= 0.03:
                            ...
                            if int(seconds_left * 10) % 20 == 0: print(f"⚠️ [STALKING] Contra muy cara (${best_ask:.2f}). Esperando a 0.03...")
